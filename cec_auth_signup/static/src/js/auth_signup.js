openerp.cec_auth_signup = function(instance) {
    instance.cec_auth_signup = instance.cec_auth_signup || {};
    ...
    instance.web.Login.include({
        ...
        on_token_loaded: function(result) {
            ...
            if (result.token) {
                ...
                if (this.params.type === 'signup'){
                    ...
                    this.rpc('/auth_cec/active_user',params)
        ...
        on_submit: function(ev) {
            ...
            if (login_mode === 'signup' || login_mode === 'reset') {
                ...
                //var self = this,
                 //   super_ = this._super;
                this.rpc('/auth_cec/signup', params)
                    .done(function(result) {
                        if (result.error) {
                            self.show_error(result.error);
                        }
